...
namespace Jarboo.Admin.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProjectsController : Jarboo.Admin.Web.Controllers.ProjectsController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int? customerId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(int? customerId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "customerId", customerId);
            CreateOverride(callInfo, customerId);
            return callInfo;
        }
