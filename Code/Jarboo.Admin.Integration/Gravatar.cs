...
namespace Jarboo.Admin.Integration
{
    public static class Gravatar
    {
        ...
        public static string RenderGravatar(string email,
                                      int? size = null,
                                      ...
                                      object htmlAttributes = null)
        {
            ...
            if (size != null)
            {
                if (size < 1 || size > 512) throw new ArgumentOutOfRangeException("size", size, "Must be null or between 1 and 512, inclusive.");
            ...
            {
                tag.Add(attr.Key + "=\"" + attr.Value + "\"");
            }
            tag.Add("src=\"" + url.ToString() + "\"");
            if (size != null)
            {
                tag.Add("width=\"" + size.ToString() + "\"");
                tag.Add("height=\"" + size.ToString() + "\"");
            }
            tag.Add("/>");
            return string.Join(" ", tag.ToArray());
        }
